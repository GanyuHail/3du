 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var lw=ro.exports,uw=Symbol.for("react.element"),cw=Symbol.for("react.fragment"),fw=Object.prototype.hasOwnProperty,dw=lw.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,hw={key:!0,ref:!0,__self:!0,__source:!0};function Dg(n,e,t){var i,r={},s=null,o=null;t!==void 0&&(s=""+t),e.key!==void 0&&(s=""+e.key),e.ref!==void 0&&(o=e.ref);for(i in e)fw.call(e,i)&&!hw.hasOwnProperty(i)&&(r[i]=e[i]);if(n&&n.defaultProps)for(i in e=n.defaultProps,e)r[i]===void 0&&(r[i]=e[i]);return{$$typeof:uw,type:n,key:s,ref:o,props:r,_owner:dw.current}}rl.Fragment=cw;rl.jsx=Dg;rl.jsxs=Dg;(function(n){n.exports=rl})(Pg);const Oa=Pg.exports.jsx;function pw(){ro.exports.useEffect(()=>{const e=new KM,t=new Gt(50,window.innerWidth/window.innerHeight,1,1e3);t.position.z=96;const i=document.getElementById("myThreeJsCanvas"),r=new bg({canvas:i,antialias:!0});r.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(r.domElement);const s=new sw(16761035,.5);s.castShadow=!0,e.add(s);const o=new rw(16777215,1);o.castShadow=!0,o.position.set(0,64,32),e.add(o);const a=new xf(12,64,32),l=new tw().load("https://raw.githubusercontent.com/GanyuHail/3dUni/af0410ab94f43f47c605838cd9db4d380639afb7/src/assets/uni.jpg"),u=new mf({map:l}),c=new Wn(a,u);e.add(c);const f=new aw(t,r.domElement);new ow,new Me;const d=()=>{boxMesh.rotation.x+=.001,boxMesh.rotation.y+=.001,f.update(),r.render(e,t),window.requestAnimationFrame(d)};d()},[]),window.addEventListener("resize",n,!1);function n(){camera.aspect=window.innerWidth/window.innerHeight,camera.updateProjectionMatrix(),renderer.setSize(window.innerWidth,window.innerHeight),render()}return Oa("div",{children:Oa("canvas",{id:"myThreeJsCanvas"})})}pu.createRoot(document.getElementById("root")).render(Oa(e0.StrictMode,{children:Oa(pw,{})}));
